...
class TestConsole(unittest.TestCase):
    """
    tests console and class methods and objects
    """
    def test_class(self):
        """
        checks if all required classes are present
        """
        city1 = City()
        amenity1 = Amenity()
        state1 = State()
    ...
    def test_father(self):
        """
        checks if all classes inherit correctly from BaseModel
        """
        city1 = City()
        amenity1 = Amenity()
        state1 = State()
...
class TestHBNBCommand_help(unittest.TestCase):
    """tests help messages of the console"""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """tests exit prompts from the HBNB command interpreter."""
